# Postchi documentation

Additional guides for operators and contributors.
...
| Area | Path |
|------|------|
| Documentation workspace | `/workspaces/:id/docs` |
| API catalog | `/workspaces/:id/catalog` |
| Workspace settings → Documentation | GitHub/GitLab doc sources and CI tokens |
| Request → Docs tab | Per-request documentation bundle |
